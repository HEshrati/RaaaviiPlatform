...
exports.CrmModule = CrmModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([user_behavior_event_entity_1.UserBehaviorEvent, crm_ai_alert_entity_1.CrmAiAlert]),
        ],
        controllers: [crm_controller_1.CrmController],
        providers: [crm_service_1.CrmService],
        exports: [crm_service_1.CrmService], // برای استفاده در سایر ماژول‌ها
    })
], CrmModule);
