...
exports.MyTherapistTables1746600000000 = void 0;
class MyTherapistTables1746600000000 {
    constructor() {
        this.name = 'MyTherapistTables1746600000000';
    }
    ...
    `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_therapist_profiles_active" ON "therapist_profiles" ("is_active", "verified");`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_support_groups_status" ON "support_groups" ("status");`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_therapy_bookings_user_status" ON "therapy_session_bookings" ("user_id", "status");`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_therapy_bookings_therapist" ON "therapy_session_bookings" ("therapist_id", "scheduled_at");`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "UQ_user_group_active" ON "support_group_memberships" ("user_id", "group_id") WHERE status IN ('pending','active','on_waitlist');`);
    }
...
exports.MyTherapistTables1746600000000 = MyTherapistTables1746600000000;
